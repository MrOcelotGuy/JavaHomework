...
public class Listing21_06SetListPerformanceTest {
...
// for 50000 elements
// Member test time for hash set is 11 milliseconds
// Remove element time for hash set is 9 milliseconds
// Member test time for linked hash set is 7 milliseconds
// Remove element time for linked hash set is 11 milliseconds
// Member test time for tree set is 31 milliseconds
// Remove element time for tree set is 16 milliseconds
// Member test time for array list is 2906 milliseconds
// Remove element time for array list is 896 milliseconds
// Member test time for linked list is 4905 milliseconds
// Remove element time for linked list is 2002 milliseconds
